package com.study.rule.cep.cep5.temprature.subscriber;

import java.util.Map;

import org.springframework.stereotype.Component;

import com.study.rule.cep.cep5.temprature.TemperatureEvent;
...
public class CriticalEventSubscriber implements StatementSubscriber {
    ...
    public String getStatement() {
        ...
        String crtiticalEventExpression = "select * from TemperatureEvent " + "match_recognize ( "
