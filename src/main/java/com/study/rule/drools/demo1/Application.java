 ...
 * @version $Id: Application.java v 0.1 2020/7/17 1:38 下午 pez1420 Exp $$
 */
public class Application {
    ...
    public static KieSession getSession(String rule) {
        ...
        try {
            ...
            builder.add(ResourceFactory.newByteArrayResource(rule.getBytes("UTF-8")),
                ResourceType.DRL);
    ...
    private static KieSession check(String sq) throws Exception {
        ...
        kieSession.setKieContainer("test", kieServices
