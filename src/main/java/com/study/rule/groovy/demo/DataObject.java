...
public class DataObject extends LinkedHashMap<String, Object> {
    ...
    private Set<String>          xPathKeyCache    = new LinkedHashSet<>();
    ...
    public Object getObject(String name) {
        ...
        if (name.indexOf(".") > 0) { //说明是xpath格式
                ...
                for (String n : names) {
                    ...
                    if (curObject == null || !curObject.containsKey(n)) {
                        throw new NullPointerException(
                            MessageFormat.format("attribute [{0}] not exists in DataObject",
                                nPath.substring(0, nPath.length() - 1)));
                    }
            ...
            if (!containsKey(name)) {
                throw new NullPointerException(
                    MessageFormat.format("attribute [{0}] not exists in DataObject", name));
            }
            object = get(name);
        }
        return object;
    ...
    public String getJSONString() {
        ...
        return JSON.toJSONString(this, slizeCfg, SerializerFeature.WriteMapNullValue,
            SerializerFeature.PrettyFormat, SerializerFeature.WriteNonStringKeyAsString,
    ...
    public enum DataType {
                          Object, String, Double, BigDecimal, Integer, Date, Boolean, UnKnow
    }
}
