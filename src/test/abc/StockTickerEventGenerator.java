 ...
 * @version $Id: StockTickerEventGenerator.java v 0.1 2020/9/27 5:09 下午 pez1420 Exp $$
 */
public class StockTickerEventGenerator {

    private Random random = new Random(System.currentTimeMillis());

    public LinkedList<Object> makeEventStream(int numberOfTicks, int ratioOutOfLimit,
                                              int numberOfStocks, double priceLimitPctLowerLimit,
                                              double priceLimitPctUpperLimit,
                                              double priceLowerLimit, double priceUpperLimit,
                                              boolean isLastTickOutOfLimit) {
        LinkedList<Object> stream = new LinkedList<>();

        PriceLimit[] limitBeans = makeLimits("example_user", numberOfStocks,
            priceLimitPctLowerLimit, priceLimitPctUpperLimit);
        ...
        StockTick[] initialPrices = makeInitialPriceStockTicks(limitBeans, priceLowerLimit,
            priceUpperLimit);
    ...
    public PriceLimit[] makeLimits(String userName, int numBeans, double limitPctLowerBoundary,
